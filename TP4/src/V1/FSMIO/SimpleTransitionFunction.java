...
public class SimpleTransitionFunction {
	...
	// TODO : Observe memory allocation below 
	this.nextState = new String[stateNames.length][inputs.length];
	this.output = new int[stateNames.length][inputs.length];


	// TODO (V1.Q2) : initialize nextState/output with empty string or -1 value (4 lines)
	//

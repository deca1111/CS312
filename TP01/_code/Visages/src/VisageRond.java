...
public class VisageRond  {
  ...
  public void dessiner(Graphics g){
  	...
  	// dessiner la bouche
  	g.drawArc(xhg + largeur / 4, yhg + (2*hauteur)/4, (2*largeur)/4, (hauteur)/3,0,180);
  	// dessiner les yeux
  	int largeurOeil = largeur /5;
  	int hauteurOeil =hauteur/5;
  	drawHeart(g,xhg + largeurOeil, yhg + hauteurOeil, largeurOeil, hauteurOeil);
  	drawHeart(g,xhg + 3 * largeurOeil, yhg + hauteurOeil, largeurOeil, hauteurOeil);
	}
